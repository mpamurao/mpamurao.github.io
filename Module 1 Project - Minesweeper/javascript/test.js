squares.forEach((square, index) => {
    // add event listener - calls the given function when the event happens
    // event in this case is "click"
    // the given function is generated by generateClickFunctions
    //  the function clicks the square and is only run when the square is clicked
